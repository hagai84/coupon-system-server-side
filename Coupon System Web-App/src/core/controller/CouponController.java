...
//	private final int RETRIES = 3;
	 ...
	 * @return a new AdminFacade instance if admin's user name and password are correct; otherwise, throws {@link CouponController}
	 * @throws AdminFacadeException if user name or password are incorrect
	 */
	/*public static IController login(String name, String password) throws CouponSystemException {
		if(name.equals("admin")&&password.equals("1234")) {
			return new CouponController();
		}else
			throw new CouponSystemException("Admin : incorrect user name and/or password ");
	}*/
...
*/	
	 ...
	 */
	public Collection<CouponBean> getAllPurchasedCoupons(long customerId) throws  CouponSystemException{
	 ...
	 * @throws CustomerFacadeException If retrieval of coupons fails
	 */
	public Collection<CouponBean> getAllPurchasedCouponsByType(long customerId, CouponType type) throws CouponSystemException {
	 ...
	 * @throws CustomerFacadeException If retrieval of coupons fails
	 */
	public Collection<CouponBean> getAllPurchasedCouponsByPrice(long customerId, double price) throws CouponSystemException {
	...
	/*public void createCoupon(Coupon coupon) throws CompanyFacadeException {
		// generate new unique coupon id
		try {
			coupon.setId(IdGenerator.generatCouponId());
		} catch (IdGeneratorException e) {
			CompanyFacadeException exception = new CompanyFacadeException("cant create new coupon", e);
			throw exception;
		}
		...
		try {
			...
			CompanyFacadeException CompanyException = new CompanyFacadeException(
					"cant create new coupon, the genereted id is olrady in db");
		...
		try {
			...
			CompanyFacadeException CompanyException = new CompanyFacadeException(
					"cant create new coupon, the title is olrady in db");
			throw CompanyException;
		...
		try {
			...
			CompanyFacadeException exception = new CompanyFacadeException("cant create new coupon : \n" + e.getMessage(), e);
			throw exception;
		}
	...
	/*public void removeCoupon(Coupon coupon) throws CompanyFacadeException {
		...
		try {
			...
			CompanyFacadeException exception = new CompanyFacadeException("cant remove coupon", e);
			throw exception;
		}
	}*/
	...
	public void updateCoupon(CouponBean coupon, long companyId) throws CouponSystemException {
		...
		try {
			...
			throw new CompanyException("Coupon " + coupon.getId() + " doesn't belong to company " + companyId);			
			}*/
	...
	/*public void updateCoupon(Coupon clientCoupon) throws CompanyFacadeException {
		...
		try {
			...
			// use the coupon data from db and change the filds that we want to updat (end
			// date and price)
			...
			CompanyFacadeException exception = new CompanyFacadeException("cant update new coupon : \n" + e.getMessage(), e);
			throw exception;
		}
	...
	/*public Coupon getCoupon(long couponID) throws CouponSystemException {
			...
			try {
				...
				CompanyFacadeException exception = new CompanyFacadeException("cant get coupon data from db", e);
				throw exception;
			}
